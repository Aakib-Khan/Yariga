...
const PropertyDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetchCoordinates = async () => {
      ...
      if (data && data.features && data.features.length > 0) {
        ...
        const map = new mapboxgl.Map({
          container: "map",
          style: "mapbox://styles/akib-khan/cl9xqr928003x15phq7zgvijn",
        ...
        map.addControl(
          //@ts-ignore
          new mapboxgl.FullscreenControl({ position: "top-left" })
        );
        map.addControl(
          //@ts-ignore
    ...
    fetchCoordinates();
  }, [propertyDetails,lng, lat,viewport]);
  ...
  const isCurrentUser = showUserInfo?.email === propertyDetails?.agent?.agentMail;
        ...
        >
          ...
          >
            ...
            >
              <img
                src={
                  checkImage(propertyDetails?.agent?.photo)
                    ? propertyDetails?.agent?.photo
              ...
              <Box mt="15px">
                <Typography fontSize={18} fontWeight={600} color="#11142D">
                  {propertyDetails?.agent?.agentName}
                </Typography>
                <Typography
                  mt="5px"
                  fontSize={14}
              ...
              <Typography mt={1} fontSize={16} fontWeight={600} color="#11142D">
                {propertyDetails?.agent?.allProperties.length} Properties
              </Typography>
            </Stack>
          ...
          <Stack>
            <div id="map" style={{ height: "306px",width:"306px" }} />
